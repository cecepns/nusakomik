      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden z-0">
        ...
        <div
          className={`absolute bottom-[-10%] left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full blur-[120px] opacity-30 transition-opacity ${
            isLightMode ? "bg-sky-300/30" : "bg-blue-900/30"
          }`}
        />
      </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <div className="flex items-center gap-2">
                      <p
                        className={`text-base font-extrabold sm:text-lg transition-colors group-hover:text-sky-400 ${
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`h-4 w-4 shrink-0 transition-transform duration-200 text-sky-400 ${
